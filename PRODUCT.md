...
Polish speakers learning English online, split across two cohorts the page must serve equally:

- **Adults (25–45)** preparing for work, travel, or life abroad. They want to unblock speaking, repair grammar gaps, and gain confidence in real conversations and calls. They self-select; the decision is theirs.
- **Teenagers (14–19) and their parents**, often preparing for matura or other school exams. Parents pay; teens use. Both audiences read the page, so tone has to land on both sides without picking a side.

Context of use: someone landed here from a search, a referral, or a social link. They are evaluating whether this teacher is the right fit. They are not yet committed; they are reading carefully.

## Product Purpose

BeChatty is the personal landing page of an English teacher with 10+ years of experience and 450+ students taught. The page does three jobs at once and refuses to pick one:

1. **Convert trial lessons** — every section should plausibly lead to the contact CTA.
2. **Build trust through method, voice, and proof** — credentials, reviews, and the teacher's personality, not testimonial fluff.
3. **Show prices and services clearly** — prospects who already want to compare should not have to dig.

Success looks like: a visitor who arrives unsure, leaves convinced this is a real teacher with a real method, and either books a trial or remembers the name well enough to come back.
...
Emotional goals when visitors read the page: relief ("this person seems serious and approachable"), curiosity ("I want to know the method"), and trust ("this is someone qualified I'd actually want to learn from"). Adults considering a paid commitment and parents evaluating where to send their teenager must both feel they are in the right place.
